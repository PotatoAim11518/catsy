  ...
  return (
    <div className={styles.aboutContainer}>
      ...
      <div className={styles.aboutSection}>
        <div className={`${styles.imageContainer} ${styles.communityCat}`}></div>
      ...
      <div className={styles.aboutSection}>
        ...
        <div className={`${styles.imageContainerAlt} ${styles.trancendentCat}`}
        ></div>
      </div>
      <div className={styles.aboutSection}>
        <div className={`${styles.imageContainer} ${styles.familyCat}`}
        ></div>
        <div className={styles.aboutSectionText}>
